...
const tiers: PricingTier[] = [
  ...
  {
    name: "Developer",
    tagline: "For indie builders shipping AI agents in production",
    pricing: { monthly: 29, annual: 24, annualBadge: "Save 17%" },
    checks: "100",
  ...
  {
    name: "Team",
    tagline: "For teams building with MCP servers at scale",
    pricing: { monthly: 99, annual: 82, annualBadge: "Save 17%" },
    checks: "500",
    cta: "Start Team Plan",
    ctaHref: "/signup",
    highlighted: true,
  ...
  },
  {
    ...
    pricing: { monthly: 299, annual: 248, annualBadge: "Save 17%" },
    checks: "2,000",
    cta: "Start Startup Plan",
    ctaHref: "/signup",
    features: [
      "2,000 scans/month",
      "500,000 tool calls/month",
      "Unlimited API keys",
      "Unlimited seats",
      "100 MCP servers",
      "Policy engine",
...
const comparisonRows: ComparisonRow[] = [
  {
    ...
    values: ["$0", "$24", "$82", "$248", "Custom"],
  },
  {
    feature: "Price/mo (monthly)",
    values: ["$0", "$29", "$99", "$299", "Custom"],
  },
  {
    feature: "Scans/month",
    values: ["50", "100", "500", "2,000", "Unlimited"],
  },
  {
    feature: "Tool calls/month",
    values: ["5,000", "25,000", "150,000", "500,000", "Unlimited"],
  },
  {
    feature: "MCP servers",
    values: ["1", "5", "25", "100", "Unlimited"],
  },
  {
    feature: "Seats",
    values: ["1", "3", "10", "Unlimited", "Custom"],
  },
  {
    feature: "Pre-connect scan",
  ...
  {
    feature: "Remediation config",
    values: [true, true, true, true, true],
  },
  {
    feature: "Runtime proxy",
